...
#define restoreRegisters() \
    asm volatile("movq %[indexCX],rcx; movq %[indexDX],rdx; pop rbx; pop rbp; pop rsi; pop rdi; pop r8; pop r9; pop r10; pop r11; pop r12; pop r13; pop r14; pop r15;" : : [indexCX] "m" (saveArea[0]), [indexDX] "m" (saveArea[1]));
